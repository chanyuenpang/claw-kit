...
This pass changes the Codex adapter so review and completion deposition are modeled as delegated specialist workflows rather than main-agent inline chores.

## Changes

- `packages/codex-adapter/skills/plan-review/SKILL.md`
  - now describes plan review as a fresh delegated review subagent workflow
...
- `packages/codex-adapter/skills/master-workflow/SKILL.md`
  - now tells the main agent to dispatch review and deposition specialists
