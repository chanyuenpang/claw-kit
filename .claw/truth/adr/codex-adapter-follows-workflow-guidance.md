...
- 显式消费 `askUser`、`recommendedCommands`、`nextStep` 与 host-specific progress actions；researcher 是否进入 foreground delegation 由 `.claw/truth/features/codex-subagent-reuse.md` 的代码调查边界决定，本文不重复其触发或执行合同
