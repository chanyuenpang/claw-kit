...
- runtime project resolution loads canonical `.claw/project.json` first, then deep-merges `.claw/project-override.json` when that gitignored personal overlay exists.
