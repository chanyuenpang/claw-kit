...
const PROFILES: Readonly<Record<IntegrationHost, HostIntegrationProfile>> = {
  ...
  opencode: { version: 1, consumesPlanGoalEffects: false, supportsNativeSubagentFinalization: false, registersKnowledgePlanOnCreation: true, tracksKnowledgeFinalization: true, suppressesAgentGoalGuidance: true, usesGoalObjectiveInTaskDetail: false, usesAtomicKnowledgeDispatch: false, supportsClaimTimeReportCapture: false, providesActiveWorkflowRecovery: false, omitsCompactNotes: false, allowedKnowledgeExecutionPolicies: MAIN_AGENT_ONLY_DEFAULT, defaultKnowledgeExecutionPolicy: "background" },
  ...
  standard: { version: 1, consumesPlanGoalEffects: false, supportsNativeSubagentFinalization: false, registersKnowledgePlanOnCreation: true, tracksKnowledgeFinalization: true, suppressesAgentGoalGuidance: true, usesGoalObjectiveInTaskDetail: false, usesAtomicKnowledgeDispatch: false, supportsClaimTimeReportCapture: false, providesActiveWorkflowRecovery: false, omitsCompactNotes: false, allowedKnowledgeExecutionPolicies: MAIN_AGENT_ONLY_DEFAULT, defaultKnowledgeExecutionPolicy: "main-agent" },
};
