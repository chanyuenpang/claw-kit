...
4. Treat `claw search` as project-document recall, not code search; it is especially useful before broad research, after `claw plan write` on planned work, or before execution on low-complexity direct work when prior project context matters.
