...
2. Compare it with the current template authoring contract. Move task-specific rules into their owning sub-task details. Optimize outdated tasks, guidance, routing, validation, or companion content.
