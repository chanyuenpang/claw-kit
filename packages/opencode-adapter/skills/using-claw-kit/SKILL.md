...
11. When all tasks are done, clear your tasks list with todowrite, update both `retrospective` and `keyDecisions`, and dispatch `adr-writer` from returned `workflowGuidance`.
